...
is a depensatory density-dependent mortality (DDM) model, where natural mortality 
...
those data, is a SISCAH model with a density dependent $M$ (DDM) hypothesis. 
A DDM hypothesis is supported by figure <insert figure> which shows that and 
biomass declines natural mortality increases.The EM provides annual estimates of 
unfished biomass and a 1-year ahead 
...
apply the following:
      ...
      iii) Apply the HS 30-60 harvest control rule to generate a

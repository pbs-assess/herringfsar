...
1. Implementing a LRP using an analysis of stock productivity [@kronlund2017]
and which is well-above the default LRP of 0.4$B_{MSY}$ [@dfo2009]. 
...
harvest ($maxTHR$) of 14\% (green solid line, Figure \@ref(fig:hcrPlot)).

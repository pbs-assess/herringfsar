...
likelihood function with correlated age-compositions. The inclusion of DDM 
...
the conservation objective (#refSecThisDoc) and that is
...
A suite of biological and fishery reference points are included in the MP evaluations
for SoG Herring. 
These are:

1.	Fractions of unfished spawning biomass, ${B_0}$,
...
In 2023, DFO Resource Management selected and implemented 
$0.8 \overline{\B}_{1998:2007}$ as a "provisional USR" within 2022/23 IFMP 

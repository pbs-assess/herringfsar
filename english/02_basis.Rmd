...
```{r yieldSSBcurve, }
yieldSSBcap <- "Strait of Georgia herring operating model 1 equilibrium yield curve with respect to spawning stock biomass."
filepath <- "data/yieldSSB.pdf"
...
$0.8 \cdot B_{1998:2007}$ as a "provisional USR" for the 2022/23 IFMP 
...
5 USR performance metrics in this analysis: $0.8 \cdot U_{MSY}$ and 
all four candidate USRs ($B_{MSY}$ proxies from @dfo2022a).

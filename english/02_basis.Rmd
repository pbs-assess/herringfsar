...
Currently we do not specify an additional RR for SoG Herring because we select a MP 
that meets the conservation objective, avoids the LRP with high probability 

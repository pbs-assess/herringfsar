...
We explore three shapes which differ in their 
control points and maximum target harvest rates
(Figure \@ref(fig:plotHCRules)).
These choices build on previous results which showed the harvest rate as
the most influential component for meeting the conservation objective, and 
and implement a ramp as per @dfo2009. 

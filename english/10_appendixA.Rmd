...
The five SOG Herring operating models where chosen to take into account
...
Where $OM_n$ is the value of the metric from operating model number n between 1 and 5.

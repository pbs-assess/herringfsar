...
SBtRtMtFtCaption <- paste0(
  "Time series (1951-2024) of maximum likelihood estimates from the estimation model (top to bottom): blended spawn index (circles, kilotonnes) and spawning",
  " biomass (red trend, kt) and depletion (red trend),",

...
$M_b=0.562$ and $h = 0.7$) is given the highest weighting of 0.34, and the 
...
However, the EM implemented here has been simulation-tested and despite this
known positive bias the recommended MP was still able to meet the conservation objective
by maintaining the spawning biomass above the LRP with a high probability
over the long term.

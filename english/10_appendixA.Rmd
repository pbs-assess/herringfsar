...
1. $P(B_t > B_{prod})$: The probability that biomass is above the provisional $USR$, that uses the productive period.
...
at a time. For each year in the projection, apply the following:
      ...
      depletion using the harvest control rule i.e. HS 30-60 with max total harvest rate;

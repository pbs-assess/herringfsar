...
(ref:indicators-cap) Stock status indicators for Pacific Herring in the Strait of Georgia (SoG) major stock assessment region (SAR) from `r yr_range[1]` to `r yr_range[2]`. (A) Catch (black solid line) and the 2024 MP's total allowable catch advice (TAC; dashed horizontal line). (B) Spawning stock biomass (SSB), limit reference point (LRP; dashed red line), upper stock reference (USR; dashed green line), and unfished spawning biomass ($B_0$; dashed black line). (C) Natural mortality rate (M; red line). (D) Harvest rate (U, black solid line) and maximum target harvest rate (maxTHR, dashed horizontal line). (E) Recruitment of age-`r age_recruit` fish. (F) Surplus production (vertical axis) vs spawning stock biomass (horizontal axis), with the LRP (red dashed line), USR (green dashed line), and unfished biomass (black dashed line). Legend: lines indicate weighted ensemble posterior median values, and where applicable shading indicates `r ci_pct`\% credibility intervals.

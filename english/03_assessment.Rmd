...
Firstly, Pacific Herring in BC are managed regionally as 5 major stocks, 
taking into account
stock specific life history, abundance, and pressures that feed into the models. 
Secondly, the biological LRP is set to a higher value compared to those
recommended in [@dfo2009] and above the recommendation of 0.5$B_{MSY}$ 
[@shelton2008], due to mid-trophic level (middle-of-the-food-chain) nature of 
Herring which likely drives observed high variability in Herring productivity.
This allows for a certain amount of herring to remain for predators, such as
salmon and whales.
Thirdly, while these ecosystem indicators, such as predators, prey and other
environmental pressures are not directly incorporated into the 
assessment model they are modelled implicitly via time varying natural mortality 
and recruitment. 
Fourthly, [@dfo2022a] introduce a process for evaluating five different USR 
points as candidate biomass target objectives for Pacific Herring and these are
considered in the MSE process and in development of the IFMP.
Incorporating spatial, and other ecosystem indicators is an area of ongoing 
research for Pacific Herring.DFO is committed to an ecosystem approach to 
fisheries management and provides further summary of recent research 
in [@dfo2024].
...
HERRING MPs HAVE THREE COMPONENTS: DATA, ESTIMATION MODEL, HARVEST CONTROL RULE

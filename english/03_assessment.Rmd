...
We simulation tested three MPs, each with hockey-stick shaped harvest control rules 
(Figure \@ref(fig:plotHCRules)). The MP with a maximum target harvest rate of 14% 
...
hcrCaption <- paste0(
  ...
  " advice in tonnes (t; annotation).",
  " Legend:",
  " $\\hat{B}_{2025}$", 
  " is forecast spawning biomass in ", assess_yr + 1, ",",
  " $\\hat{B}_0$ is estimated unfished spawning biomass,",
  " $U_{2025}$ is harvest rate in ", assess_yr + 1, ", and",
  " $Q_{2025}$ is TAC in ", assess_yr + 1, "."
)

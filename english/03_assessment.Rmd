...
(ref:indicators-cap) Stock status indicators for Pacific Herring in the Strait of Georgia (SoG) major stock assessment region (SAR) from `r yr_range[1]` to `r yr_range[2]`. (A) Catch (line) and total allowable catch (TAC; dashed line). (B) Spawning stock biomass (SSB) in relation to the limit reference point (LRP; dashed red line), upper stock reference (USR; dotted green line), and unfished spawning biomass ($B_0$; dashed black line). (C) Fishing mortality (F; black line), removal reference (RR; dashed red line), and natural mortality (M; dotted line). (D) Recruitment of age-`r age_recruit` fish. Legend: lines indicate median values, grey shading indicates `r ci_pct`\% credibility intervals, mortality is per year (yr), biomass is in tonnes (t), and recruitment is number of fish.

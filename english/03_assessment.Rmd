...
salmon and whales.
1.    While predators, prey and other ecosystem indicators are not directly 
...
better represents the underpinning ecosystem interactions.
1.    BC Pacific Herring are managed as 5 regional stocks such that stock specific 
life history, abundance, and pressures are fed into the models. 
1.    Candidate USRs [@dfo2022a] that may differ between stocks and fisheries
have been introduced to the MSE process and IFMP.
...
A maximal harvest rate of 20% has been implemented since 1983. The realized 
harvest rate has mostly hovered below this rate since then with noticeable
declines these past few years (Figure \@ref(fig:indicators), panel D).
Since 2015 the selection of annual harvest rates has been informed by 
MP simulation testing.

<!-- SP: I think these details are explained under "Management Procedures" in 
the appendix, except for the years of data used. 
Suggest that anything necessary for understanding be moved there. 

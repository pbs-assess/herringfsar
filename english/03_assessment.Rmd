...
mortality and recruitment. The new density dependant mortality feature likely 
models underpinning ecosystem interactions.
Thirdly, Pacific Herring in BC are managed regionally as 5 major stocks, 
taking into account stock specific life history, abundance, 
and pressures that feed into the models. 
Fourthly, candidate USR biomass target objectives in [@dfo2022a] have been
introduced to the MSE process and IFMP.

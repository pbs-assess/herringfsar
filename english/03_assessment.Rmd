...
higher value than those in @dfo2009 and the 0.5$B_{MSY}$ from @shelton2008.
...
3. BC Pacific Herring are managed as 5 regional stocks such that stock specific 
life history, abundance, and pressures are fed into the models. 
4. Candidate USRs [@dfo2022a] that may differ between stocks and fisheries
...
harvest rate has mostly hovered below this rate since then with reduced harvest
